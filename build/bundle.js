...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _VueBootstrapTable = __webpack_require__(4);
	...
	_axios2.default.get('http://helpdesc.loc/api/equipments?token=sI9TiqLc2aQLgfe0Ji_kn9PPc7uNSF2l&page=2').then(function (response) {
	...
	var renderfunc = function renderfunc(colname, entry) {
	    return '</div><span>' + (0, _stringify2.default)(entry) + '</span>';
	};
	
	var handleRow = function handleRow(event, entry) {
	...
	new _vue2.default({
	    el: '#app',
	    components: {
	        VueBootstrapTable: _VueBootstrapTable2.default
	    },
	    data: {
	        logging: [],
	        showFilter: true,
	    ...
	    events: {
	        cellDataModifiedEvent: function cellDataModifiedEvent(originalValue, newValue, columnTitle, entry) {
	        ...
	        ajaxLoadedEvent: function ajaxLoadedEvent(data) {
	            console.log("ajaxLoadedEvent - data : " + data);
	        },
	        ajaxLoadingError: function ajaxLoadingError(error) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "_v-32174131/VueBootstrapTable.vue"
	  if (!module.hot.data) {
